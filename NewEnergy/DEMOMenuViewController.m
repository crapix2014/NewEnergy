...
- (void)viewDidLoad
{
    ...
    self.tableView.tableHeaderView = ({
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 30, 120, 120)];
        imageView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        imageView.image = [UIImage imageNamed:@"Image01.png"];
        ...
        //label.text = @"New Energy";
        [label setText:itemInStore.username];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0){
       ...
       NetConfigViewController *nVC=[[NetConfigViewController alloc] init];
        ...
        DEMONavigationController *navigationController = [[DEMONavigationController alloc] initWithRootViewController:aVC];
        self.frostedViewController.contentViewController = navigationController;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImage *image = [UIImage imageNamed:@"Image03"];
    cell.imageView.image = image;
    NSArray *titles = @[@"设备列表", @"网络设置", @"添加设备",@"账号管理",@"关于我们",@"退出"];
